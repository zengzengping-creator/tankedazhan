...
const GIANT_STORY_MAZE = {
  ...
  storyNodes:[
    {id:1,x:1435,y:735,r:32,title:"前哨站",text:"📡 前哨站：全迷宫已拓宽，大坦克可沿宽通道向北前进。"},
    {id:2,x:1575,y:448,r:32,title:"中继区",text:"🔋 中继区：继续沿宽通道向南绕过第二道高墙。"},
    {id:3,x:1705,y:735,r:32,title:"核心门",text:"🔓 核心门：最后一段也已拓宽，向右上方寻找绿色出口门！"}
  ],
  pits:[
    {x:1480,y:722,w:24,h:20,label:"断层A"},
    {x:1568,y:408,w:24,h:20,label:"断层B"},
    {x:1718,y:722,w:24,h:20,label:"断层C"}
  ],
  walls:[
    // 外围边界保留；内部只留3道交错高墙，每段通道约116~130像素宽，
    // 大型坦克也有充足转弯空间。
    ...
    {x:1510,y:520,w:14,h:280},
    {x:1640,y:390,w:14,h:280},
    {x:1770,y:520,w:14,h:280}
  ]
};
